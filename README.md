...
| `npm run test:labs` | The 4,840 assertions that ship inside the eight engine labs, run in real Chromium against the real pages — and the zero-network-call claim, asserted rather than eyeballed |
