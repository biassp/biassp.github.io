...
| `npm run test:labs` | The 5,259 assertions that ship inside the nine engine labs, run in real Chromium against the real pages — and the zero-network-call claim, asserted rather than eyeballed |
